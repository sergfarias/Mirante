...
//using EclipseWorks.DeveloperEvaluation.Domain.Specifications;
using EclipseWorks.DeveloperEvaluation.Unit.Domain.Specifications.TestData;
using FluentAssertions;
using Xunit;

namespace EclipseWorks.DeveloperEvaluation.Unit.Domain.Specifications
{
